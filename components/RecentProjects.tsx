  ...
  return (
    <div className="py-20" id="projects">
        ...
        <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-0 ">
            ...
            <div>
                <div key={id} className="sm:h-[15rem] h-[10rem] lg:h-[20.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
                  ...
                  <div className="flex items-center justify-between mt-7 mb-3">
                    <div className="flex items-center">
                      {iconLists.map((icon, index)=>
                        <div key={icon} className="border border-white-100/[0.2] rounded-full
