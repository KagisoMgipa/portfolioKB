    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="We'll work together to define your organization's goals and key application needs, focusing on support, deployments, 
                        system administration, and development workflows. This phase will outline system architecture, deployment strategies, 
                        and tools to ensure efficient operations."
            >
            <CanvasRevealEffect
                animationSpeed={5.1}
        ...
        <Card 
            ...
            description="After finalizing the plan, I'll begin indulging while keeping you informed throughout the process, from initial stages to final implementation."
            >
            <CanvasRevealEffect
                animationSpeed={3}
                containerClassName="bg-black"
        ...
        <Card 
            ...
            description="I'll bring everything to life by turning the approved plan into functional needs, ensuring that all systems are fully operational."
            >
            <CanvasRevealEffect
                animationSpeed={3}
                containerClassName="bg-black"
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200
                       text-center" style={{color: '#e4ecff'}}>
          {description}
        </h2>
      </div>
    </div>
